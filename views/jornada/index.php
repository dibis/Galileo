...
/* @var $searchModel app\models\searchs\JornadaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::$app->name.' - '.Yii::t('app', 'Management of').' '.Yii::t('app', 'Matchday');
$this->params['breadcrumbs'][] = Yii::t('app', 'Matchday');
?>
    ...
    GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'attribute' => 'jorCompeticion.competicioncompleta',
            ],
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    ...
                    'delete' => function($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-trash"></span>'.' '. Yii::t('app', 'Delete'), ['delete', 'id' => $model->jor_id], [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = \yii\helpers\Url::toRoute(['jornada/view', 'id' => $key]);
                        return $url;
                    } elseif ($action === 'update') {
                        $url = \yii\helpers\Url::toRoute(['jornada/update', 'id' => $key]);
                        return $url;
                    }
                }
            ],
